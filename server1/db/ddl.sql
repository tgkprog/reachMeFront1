-- Combined DDL: drop existing tables, recreate with full schema
-- Assumes current database is already selected (e.g. USE reachm1;)
-- Charset / collation consistent with utf8mb4
...
CREATE TABLE reach_me_messages (
  ...
  reached_client BOOLEAN DEFAULT FALSE,
  sent_details JSON NULL,
  auto_deactivate_at TIMESTAMP NULL,
  ...
  INDEX idx_reached_client (reached_client),
  INDEX idx_auto_deactivate (auto_deactivate_at)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
-- Optional: seed data placed in separate data.sql file
-- End of DDL
