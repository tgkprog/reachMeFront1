...
export class StorageService {
  ...
  static async getPollSettings(): Promise<{
    minutes: number;
    seconds: number;
  } | null> {
  ...
  static async getAlarmHistory(): Promise<
    { id: string; ts: number; title?: string; msg?: string }[]
  > {
  ...
  static async addAlarmToHistory(
    id: string,
    createdTs: number,
    title?: string,
    msg?: string,
